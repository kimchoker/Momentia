...
const SignUp: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#EEEDEB] font-nanum">
        ...
        <div className="w-4/5 flex flex-col">
          ...
          <div className="mb-4 flex flex-col">
            ...
            <div className="flex flex-row">
              ...
              <button
                className="flex items-center justify-center rounded-md bg-black h-[35px] p-2 transition-all duration-300 w-[20%] hover:bg-gray-700"
                onClick={() => checkID(inputEmail)}
              >
                <p className="text-white text-xs items-center justify-center">
                  중복확인
                </p>
              </button>
            </div>
